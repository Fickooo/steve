...
module.exports = {
  ...
  if(client.hasPermission('EMBED_LINKS')) return message.reply("I'm sorry, but I am not allowed to send you the link. Ask the administrators they can edit my permissions.")
