  ...
  run: async (client, message, args) => {
    ...
    if(arg == "info") {
      ...
      let funHelp = new Discord.MessageEmbed()
       ...
       .setColor("#008000")
       .setDescription('`ping`, `help`, `uptime`, `avatar`, `server-info`, `invite`, `user-info`, `bot-info`')
       .setThumbnail('https://cdn.glitch.com/8f423271-964d-4b5d-a5d1-6d18b7847df0%2FScreenshot_684.png')
       .setFooter("Requested by " + message.author.username, message.author.displayAvatarURL())
       .setTimestamp()
       return message.channel.send(funHelp)
    ...
    if(arg == "util") {
      ...
      let funHelp = new Discord.MessageEmbed()
       ...
       .setColor("#666699")
       .setDescription('`clear`,`slc (SetLogsChannel)`,`smr (SetMuteRole)`, `srl (SetReportLogs)`,`ssl (SetSuggestLogs)`, `report`, `suggest`, `dbdelete`, `arole`')
       .setThumbnail('https://cdn.glitch.com/8f423271-964d-4b5d-a5d1-6d18b7847df0%2FScreenshot_684.png')
       .setFooter("Requested by " + message.author.username, message.author.displayAvatarURL())
       .setTimestamp()
       return message.channel.send(funHelp)
